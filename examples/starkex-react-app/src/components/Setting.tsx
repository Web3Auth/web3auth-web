...
interface IProps {
  ...
  selectedNetwork: WEB3AUTH_NETWORK_TYPE;
  selectedChain: CHAIN_CONFIG_TYPE;
}

const Setting = ({ setNetwork, setChain, selectedNetwork, selectedChain }: IProps) => {
  ...
  return (
    <div className={styles.setting}>
      <div className={styles.row}>
        ...
        <select id="network" onChange={networkChangeHandler} className={styles.select} disabled={isLoggedIn} value={selectedNetwork}>
      ...
      <div className={styles.row}>
        ...
        <select onChange={chainChangeHandler} className={styles.select} disabled={true} value={selectedChain}>
