...
import { BaseConnectorSettings, IBaseProvider } from "@web3auth/base";
...
export interface SocialConnectorOptions extends BaseConnectorSettings {
  connectorSettings?: MakeOptional<OpenLoginOptions, "clientId" | "network">;
