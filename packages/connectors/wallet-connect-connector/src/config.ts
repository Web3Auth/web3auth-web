...
import { CHAIN_NAMESPACES, ChainNamespaceType, IWalletConnectExtensionConnector } from "@web3auth/base";

import { IConnectorSettings } from "./interface";

export const WALLET_CONNECT_EXTENSION_CONNECTORS: IWalletConnectExtensionConnector[] = [
  {
    name: "Rainbow",
...
export const getWalletConnectSettings = async (
