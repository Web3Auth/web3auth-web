import { getBase58Decoder, getBase64EncodedWireTransaction, getBase64Encoder, getTransactionDecoder, type Transaction } from "@solana/kit";
import {
...
export const walletSignTransaction = async (wallet: Wallet, transaction: Transaction): Promise<string> => {
  ...
  const [sig] = Object.values(decodedTx.signatures);
