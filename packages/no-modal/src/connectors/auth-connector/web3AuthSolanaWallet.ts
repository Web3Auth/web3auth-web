...
type Web3AuthSolanaFeatures = StandardConnectFeature &
...
export class Web3AuthSolanaWallet implements Wallet {
  ...
  readonly features: Web3AuthSolanaFeatures;
  ...
  /**
   * Creates a Web3AuthSolanaWallet by fetching accounts from the provider.
   */
  static async create(provider: IProvider, chainConfig: CustomChainConfig): Promise<Web3AuthSolanaWallet> {
    ...
    return new Web3AuthSolanaWallet(provider, chainIdentifier, accounts);
  }
}
